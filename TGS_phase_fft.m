function [fft] = TGS_phase_fft(SAW_only,psd_out,truncate_fraction, plot_things)
...
% figure()
% axes('xtick',[],'ytick',[],'box','on','handlevisibility','off','LineWidth',5)
% plot(SAW_only)
% ylim([-0.01 0.02])
% hold on
...
if plotfft
    figure()
    axes('xtick',[],'ytick',[],'box','on','handlevisibility','off','LineWidth',5)
    % plot(SAW_only_padded, 'k','LineWidth',2)
